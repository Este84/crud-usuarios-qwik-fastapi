...
# Endpoint praa obtener un usuario específico por DNI.
@app.get("/users/{dni}", response_description="Obtiene un usuario", response_model=User)
...
# Endpoint para borrar un usuario especifico por DNI.
@app.delete("/users/{dni}", response_description="Borra un usuario", status_code=204)
...
# Endpoint para actualizar un usuario especifico por DNI.
@app.put("/users/{dni}", response_description="ACtualiza un usuario por el DNI", status_code=204)
